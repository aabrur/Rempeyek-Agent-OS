...
|[![Download v2.4.8](https://img.shields.io/badge/Download-v2.4.8-ff8a00?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/aabrur/Rempeyek-Agent-OS/releases/tag/v2.4.8)
...
1. Open the public **v2.4.8** release above.
...
3. Verify the downloaded installer against `SHA256SUMS.txt` in PowerShell:
   ...
   ```powershell
   Get-FileHash "$HOME\Downloads\Rempeyek-Agent-OS-Setup-2.4.8.exe" -Algorithm SHA256
   ```
