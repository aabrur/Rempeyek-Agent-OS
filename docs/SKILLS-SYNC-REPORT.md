...
## Overview
- **Canonical Skill Warehouse:** `%USERPROFILE%\.skills`
- **Node Destination:** `%USERPROFILE%\AppData\Local\Rempeyek-Agent-OS\Agents\<Node-ID>\skills`
- **Shared Registry:** `Vault\Skills\Registry\skills-registry.json`

## Synchronization Process
1. **Discovery:** Scans `%USERPROFILE%\.skills` for skill directories containing `SKILL.md`.
